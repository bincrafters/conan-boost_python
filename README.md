## This repository holds a conan recipe for Boost.Python.
...
### Basic setup
    ...
    $ conan install Boost.Python/1.64.0@bincrafters/testing
...
## Upload
    ...
    $ conan upload Boost.Python/1.64.0@bincrafters/testing --all -r bincrafters
